...
#include "take_picture_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = take_picture_interfaces__msg__Waypoint;
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_take_picture_interfaces__msg__Waypoint(
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_take_picture_interfaces__msg__Waypoint(
