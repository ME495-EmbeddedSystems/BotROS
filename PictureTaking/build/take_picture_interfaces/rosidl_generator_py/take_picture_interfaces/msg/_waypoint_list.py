...
class Metaclass_WaypointList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from take_picture_interfaces.msg import Waypoint
...
class WaypointList(metaclass=Metaclass_WaypointList):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<take_picture_interfaces/Waypoint>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['take_picture_interfaces', 'msg'], 'Waypoint')),  # noqa: E501
    )
