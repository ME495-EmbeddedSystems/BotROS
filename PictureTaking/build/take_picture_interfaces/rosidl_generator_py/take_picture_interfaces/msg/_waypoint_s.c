...
bool take_picture_interfaces__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("take_picture_interfaces.msg._waypoint.Waypoint", full_classname_dest, 46) == 0);
  }
  take_picture_interfaces__msg__Waypoint * ros_message = _ros_message;
  {  // x
...
PyObject * take_picture_interfaces__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("take_picture_interfaces.msg._waypoint");
